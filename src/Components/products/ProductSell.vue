      ...
      <div class="col-6 offset-3 pt-3 card mt-5 shadow">
        <div class="card-body">
          ...
          <div class="form-group">
            ...
            >
              <option selected disabled value="null">-Ürün Seçiniz-</option>
              <option
          ...
          <hr />
          <button class="btn btn-primary" :disabled="saveEnabled" @click="save">
            Kaydet
          </button>
        </div>
      </div>
...
export default {
  ...
  beforeRouteLeave(to, from, next) {
    //dikkat et : butona basılmamışsa bu uyarıyı yap.
    if (
